const CSLI18N = (() => {
    ...
    const translations = {
        nl: {
            ...
            payment: {
                eyebrow: 'Stap 3',
                title: 'Controleer je samenvatting en betaal veilig via Stripe',
                ...
                summaryIntro: 'Controleer nog een keer de kamers, data en totaalprijs.',
                roomsLabel: 'Kamers',
                stayLabel: 'Periode',
                guestLabel: 'Gast',
                totalLabel: 'Totaal',
                ...
                holdExpired: 'De hold is verlopen. Kies opnieuw je kamers.',
        ...
        en: {
            ...
            payment: { eyebrow: 'Step 3', title: 'Review your summary and pay securely with Stripe', text: 'Your rooms are temporarily held for you. Complete payment before the timer ends.', summaryTitle: 'Your reservation', summaryIntro: 'Check the rooms, dates and total one more time.', roomsLabel: 'Rooms', stayLabel: 'Period', guestLabel: 'Guest', totalLabel: 'Total', backButton: 'Back to booking', payNow: 'Pay with Stripe', redirecting: 'Redirecting you to Stripe...', holdExpired: 'The hold has expired. Please choose your rooms again.', noStripe: 'Stripe is not configured in this environment yet.', countdownLabel: 'Hold expires in {time}' },
        ...
        pt: {
            ...
            payment: { eyebrow: 'Passo 3', title: 'Confirme o resumo e pague com seguranca via Stripe', text: 'Os seus quartos estao temporariamente reservados para si. Conclua o pagamento antes do fim do tempo.', summaryTitle: 'A sua reserva', summaryIntro: 'Confirme os quartos, datas e total mais uma vez.', roomsLabel: 'Quartos', stayLabel: 'Periodo', guestLabel: 'Hospede', totalLabel: 'Total', backButton: 'Voltar para reservas', payNow: 'Pagar com Stripe', redirecting: 'A redirecionar para Stripe...', holdExpired: 'O hold expirou. Escolha novamente os quartos.', noStripe: 'Stripe ainda nao esta configurado neste ambiente.', countdownLabel: 'O hold expira em {time}' },
        ...
        es: {
            ...
            payment: { eyebrow: 'Paso 3', title: 'Revisa tu resumen y paga con seguridad mediante Stripe', text: 'Tus habitaciones estan retenidas temporalmente para ti. Completa el pago antes de que termine el tiempo.', summaryTitle: 'Tu reserva', summaryIntro: 'Revisa habitaciones, fechas y total una vez mas.', roomsLabel: 'Habitaciones', stayLabel: 'Periodo', guestLabel: 'Huesped', totalLabel: 'Total', backButton: 'Volver a reservar', payNow: 'Pagar con Stripe', redirecting: 'Redirigiendo a Stripe...', holdExpired: 'El hold ha expirado. Elige tus habitaciones de nuevo.', noStripe: 'Stripe todavia no esta configurado en este entorno.', countdownLabel: 'El hold vence en {time}' },
        ...
        fr: {
            ...
            payment: { eyebrow: 'Etape 3', title: 'Verifiez votre resume et payez en toute securite avec Stripe', text: 'Vos chambres sont temporairement reservees pour vous. Finalisez le paiement avant la fin du delai.', summaryTitle: 'Votre reservation', summaryIntro: 'Verifiez encore une fois les chambres, les dates et le total.', roomsLabel: 'Chambres', stayLabel: 'Periode', guestLabel: 'Client', totalLabel: 'Total', backButton: 'Retour a la reservation', payNow: 'Payer avec Stripe', redirecting: 'Redirection vers Stripe...', holdExpired: 'Le blocage a expire. Choisissez de nouveau vos chambres.', noStripe: 'Stripe n est pas encore configure dans cet environnement.', countdownLabel: 'Le blocage expire dans {time}' },
        ...
        de: {
            ...
            payment: { eyebrow: 'Schritt 3', title: 'Pruefen Sie Ihre Zusammenfassung und bezahlen Sie sicher mit Stripe', text: 'Ihre Zimmer sind temporaer fuer Sie reserviert. Schliessen Sie die Zahlung ab, bevor der Timer endet.', summaryTitle: 'Ihre Reservierung', summaryIntro: 'Pruefen Sie Zimmer, Daten und Gesamtbetrag noch einmal.', roomsLabel: 'Zimmer', stayLabel: 'Zeitraum', guestLabel: 'Gast', totalLabel: 'Gesamt', backButton: 'Zurueck zur Buchung', payNow: 'Mit Stripe bezahlen', redirecting: 'Weiterleitung zu Stripe...', holdExpired: 'Die Reservierung ist abgelaufen. Bitte waehlen Sie die Zimmer erneut.', noStripe: 'Stripe ist in dieser Umgebung noch nicht konfiguriert.', countdownLabel: 'Reservierung laeuft ab in {time}' },
